...
function setupDashboardChart(containerElementId) {
    var s1 = [45, 154, 112, 321, 231, 123, 158, 222, 231];
    var s2 = [25, 125, 145, 225, 125, 350, 240, 290, 490];
    var s3 = [44, 454, 452, 550, 482, 325, 441, 150, 150];
    var s4 = [452, 15, 124, 324, 88, 125, 321, 11, 144];
    // Can specify a custom tick Array.
    // Ticks should match up one for each y value (category) in the series.
    var ticks = ['6-5', '6-6', '6-7', '6-8', '6-9', '6-10', '6-11', '6-12', '6-13'];
