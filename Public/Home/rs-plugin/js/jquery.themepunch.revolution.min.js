...
(function (e, t) {
    ...
    function w(n, r) {
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            if (l == 12)if (r.ie9)w.transition({left: d + "px"}, 0); else w.transition({
                left: d + "px",
                rotate: r.rotate
            }, 0); else if (l == 15)if (r.ie9)w.transition({left: 0 - r.width + "px"}, 0); else w.transition({
                left: 0 - r.width + "px",
                rotate: r.rotate
            ...
            if (a == 0) {
                ...
                u.data("timer", setTimeout(function () {
                    ...
                    if (u.hasClass("lfr") || u.hasClass("lfl") || u.hasClass("sfr") || u.hasClass("sfl") || u.hasClass("lft") || u.hasClass("lfb") || u.hasClass("sft") || u.hasClass("sfb")) {
                        ...
                        }, {duration: u.data("speed"), easing: e});
                        if (r.ie)u.addClass("noFilterClass")
                    }
                }, u.data("start")));
