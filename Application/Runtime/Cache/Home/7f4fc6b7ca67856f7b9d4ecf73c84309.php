                    ...
                    <div class="two-third column-last">
                        <section id="options">
                            <ul id="filters" class="option-set clearfix" data-option-key="filter">
                                ...
                                <li><a href="#filter" data-option-value=".zhuangbi">装逼必备</a></li>
                                <li><a href="#filter" data-option-value=".sport">运动</a></li>
                                <li><a href="#filter" data-option-value=".xiaolv">效率</a></li>
                                <li><a href="#filter" data-option-value=".bigger">有逼格的APP</a></li>
                                <li><a href="#filter" data-option-value=".design">设计尸</a></li>
                                <li><a href="#filter" data-option-value=".coder">程序猿</a></li>
                            </ul>
                        </section>
                    </div>
                    <div class="clear"></div>
    ...
    <div class="centered-wrapper">
        <section id="portfolio-wrapper">
            <ul class="portfolio grid ">
                <li data-category="" class="zhuangbi xiaolv item-wide">
                    <a href="<?php echo U('detail?id=2');?>">
                ...
                <li data-category="" class="sport bigger xiaolv item-small">
                ...
                <li data-category="" class="zhuangbi coder sport design item-high">
                    <a href="<?php echo U('detail?id=2');?>">
                        <div class="grid-item-on-hover">
                            <div class="grid-text">
                ...
                <li data-category="" class="sport coder bigger  xiaolv item-small">
                    <a href="<?php echo U('detail?id=2');?>">
                        <div class="grid-item-on-hover">
                            <div class="grid-text">
                                <h1>Adidas Store</h1>
                ...
                <li data-category="" class="design item-small">
                    <a href="<?php echo U('detail');?>">
                        <div class="grid-item-on-hover">
                            <div class="grid-text">
                ...
                <li data-category="" class="zhuangbi design item-small">
                    <a href="<?php echo U('detail?id=2');?>">
                        <div class="grid-item-on-hover">
                            <div class="grid-text">
                ...
                <li data-category="" class="sport coder item-long">
                    <a href="<?php echo U('detail?id=2');?>">
                        <div class="grid-item-on-hover">
                            <div class="grid-text">
                                <h1>Carlito`s Bar </h1>
                ...
                <li data-category="" class="zhuangbi bigger item-high">
                    <a href="<?php echo U('detail?id=2');?>">
                        <div class="grid-item-on-hover">
                            <div class="grid-text">
                                <h1>Carlito`s Bar </h1>
                        ...
                        <img src="/0/1/Public/Home/images/portfolio/image (3).jpg" alt=" " />
                    </a>
                </li>
                <li data-category="" class="sport coder xiaolv item-small">
                    <a href="<?php echo U('detail?id=2');?>">
                        <div class="grid-item-on-hover">
                            <div class="grid-text">
                                <h1>Carlito`s Bar </h1>
                        ...
                        <img src="/0/1/Public/Home/images/portfolio/image (1).jpg" alt=" " />
                    </a>
                </li>
                <li data-category="" class="bigger  item-wide">
                    <a href="<?php echo U('detail');?>">
                        <div class="grid-item-on-hover">
                            <div class="grid-text">
                                <h1>Carlito`s Bar </h1>
                        ...
                        <img src="/0/1/Public/Home/images/portfolio/image (2).jpg" alt=" " />
                    </a>
                </li>
                <li data-category="" class=" design coder xiaolv item-small">
                    <a href="<?php echo U('detail?id=2');?>">
                        <div class="grid-item-on-hover">
                            <div class="grid-text">
                                <h1>Carlito`s Bar </h1>
                        ...
                        <img src="/0/1/Public/Home/images/portfolio/image (4).jpg" alt=" " />
                    </a>
                </li>
